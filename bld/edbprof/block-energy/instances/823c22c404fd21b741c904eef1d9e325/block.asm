...
ret
.Lfunc_end2:
	.size set_global_range, .Lfunc_end2-set_global_range
...
ret
.Lfunc_end3:
	.size init_hw, .Lfunc_end3-init_hw
...
ret
.Lfunc_end4:
	.size msp_watchdog_disable, .Lfunc_end4-msp_watchdog_disable
...
ret
.Lfunc_end5:
	.size msp_clock_setup, .Lfunc_end5-msp_clock_setup
