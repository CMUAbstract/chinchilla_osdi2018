...
class EDB:
    ...
    def stream(self, streams, duration_sec=None, out_file=None, silent=True, no_parse=False,
               stop_pattern=None, abort_after_watchpoints=None):
                            ...
                            for stream in streams:
                                ...
                                if stream in data_point.value_set:
                                    ...
                                    if stream == 'WATCHPOINTS':
                                        ...
                                        if stop_pattern_re is not None and stop_pattern_re.match(trailing_wp_string) or \
                                                abort_after_watchpoints is not None and \
                                                len(trailing_wp_string) >= abort_after_watchpoints:
                                            stop_condition = True
