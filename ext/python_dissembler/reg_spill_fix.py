...
# Code for overhead measurement
# We never use r7, so r7 is used for overhead measure
# (just stupid tmp code)
def GPIO_SET():
    if OVERHEAD == NV_STACK:
        print "\tmov.b\t&0x0202, r7"
        print "\tbis.w\t#16, r7"
        print "\tmov.b\tr7, &0x0202"
        ...
        for line in prev_line:
            ...
            if push_counter > 0:
                ...
                if line == prev_line[1]:
                    ...
                    # Temp code for overhead measurement
                    GPIO_SET();
